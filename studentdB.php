  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block"><?php echo $fname;?></span>
      </a>
          ...
          <div class="row"> 
            ...
            <div class="col-xxl-5 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Orders <span>| Today</span></h5>
            ...
            <div class="col-xxl-5 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">History <span>| This Month</span></h5>
            ...
            <div class="col-xxl-5 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Delivered <span>| This Year</span></h5>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>
                      <?php
                        $count = mysqli_query($conn, "SELECT * FROM cart");
