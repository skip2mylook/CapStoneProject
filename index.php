	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="cart.php">For Men</a>
                <a class="dropdown-item" href="checkout.php">For Women</a>
				<a class="dropdown-item" href="checkout.php">Accessesories</a>
    ...
    <section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
    	<div class="container">
    		<div class="row">
	            ...
	            <h2 class="mb-4">New Women's Clothing Summer Collection 2023</h2>
    		...
    		<div class="row">
	            ...
	            <h2 class="mb-4">New Men's Clothing Collection 2023</h2>
	            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
	            <p><a href="#" class="btn btn-white px-4 py-3">Shop now</a></p>
    				</div>
    			</div>
