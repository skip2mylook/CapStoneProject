	        ...
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                    <a class="dropdown-item" href="login.php" data-bs-toggle="modal" data-bs-target="#Modal">Login</a>
                    <a class="dropdown-item" href="reg.php" data-bs-toggle="modal" data-bs-target="#Modal2">Create An Account</a>
                </div>
              </li>
