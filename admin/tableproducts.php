    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="products-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="addproducts.php" data-bs-toggle="modal" data-bs-target="#Add">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="tableproducts.php">Product management</a></li>
    ...
    <div class="col-lg-6">
            ...
            <div class="modal fade" id="Add" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
              ...
              <h5 class="modal-title" id="ModalLabel" style="font-size: 30px; font-weight: bold;">Add Products</h5>
            ...
            <div class="col">
                ...
                <div class="input-group">
                    <select id="inputState" name="category" class="form-select" style="border: 1px solid" required>
                ...
                <div class="input-group mb-3">
                    <input type="file" name="pic" accept=".jpg, .jpeg, .webp, .png, .gif, .jfif" class="form-control" required style="border: 1px solid">
                </div>

                </p>
                <label>Product Name:</label>
                <div class="input-group">
                    <input type="text" name="itemName" style="border: 1px solid" class="form-control" required>
                </div>
            ...
            <div class="col">
                ...
                <div class="input-group">
                    <input type="text" name="description" style="border: 1px solid" class="form-control" required>
                </div>

                </p>
                <label>Sizes:</label>
                <div class="input-group">
                    <select id="inputState" name="sizes" class="form-select" style="border: 1px solid" required>
                ...
                <label>Stock:</label>
                <div class="input-group">
                    <input type="text" name="stock" style="border: 1px solid" class="form-control" required>
                </div>

                </p>
                <label>Price:</label>
                <div class="input-group">
                    <input type="text" name="price" class="form-control" style="border: 1px solid" required>
                </div>
            </div>
        </div>
            ...
            <div class="modal-footer">
                  ...
                  <input type="submit" name="add_btn" value="Add Item"  class="btn btn-success"></input>
             </div>
          </form>
          </div>
        </div>
