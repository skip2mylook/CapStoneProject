<?php
    ...
    $getdata = mysqli_query($conn, "SELECT * FROM addproducts
    WHERE id='$ref_id'");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="tableproducts.php">Product Management</li>
            ...
            <div class="card-body">
              ...
              <p></p>
                    <form class="row g-4" action="adminprocess.php?id=<?php echo $ref_id;?>" method="POST">
                        <div class="col-md-12">
                        <input type="text" name="up_itemName" value="<?php echo $itemName; ?>" class="form-control" required placeholder="Item Name">
                        </div>
                        <div class="col-md-12">
                        <select id="inputState" name="up_sizes" value="<?php echo $sizes; ?>"class="form-select" required>
                        ...
                        <div class="col-md-12">
                        <input type="text" name="up_quantity" value="<?php echo $quantity; ?>" class="form-control" required placeholder="Quantity">
                        </div>
                        <div class="col-md-12">
                        <input type="text" name="up_price" value="<?php echo $price;?>"class="form-control" required placeholder="Price Per Unit">
                        </div>
                
                <div class="modal-footer">
                    <input type="reset" value="Clear"  class="btn btn-secondary btn-lg"> &nbsp;&nbsp;&nbsp;
                    
                    <input type="submit" name="update_btn" value="Update"  class="btn btn-success btn-lg">
                </div>
