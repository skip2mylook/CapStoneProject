...
<head>
  ...
  <title>Update / Data - Dashboard - PhinmaUI Merch.</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="studentdata.php">User Management </a></li>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <p></p>
              <p></p>
                    <form class="row g-4" action="adminprocess.php?id=<?php echo $ref_id;?>" method="POST">
                    <div class="col fw-bold">
                        <div class="col-md-12">
                        <label>First Name: </label>
                        <input type="text" name="up_fname" value="<?php echo $fname; ?>" class="form-control" required placeholder="First Name">
                        </div>
                        <br>
                        <label>Middle Initial: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_mname" value="<?php echo $mname; ?>" class="form-control" required placeholder="Middle Name">
                        </div>
                        <br>
                        <label>Last Name: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_lname" value="<?php echo $lname;?>"class="form-control" required placeholder="Last Name">
                        </div>
                        <br>
                        <label>Email: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_email" value="<?php echo $email; ?>" class="form-control" required placeholder="Email">
                        </div>
                        <br>
                    </div>
                    ...
                    <div class="col fw-bold">
                        <div class="col-md-12">
                        <label>Address:</label>
                        <input type="text" name="up_address" value="<?php echo $address;?>"class="form-control" required placeholder="Address">
                        </div>
                        <br>
                        <label>Date of Birth: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_dob" value="<?php echo $dob; ?>" class="form-control" required placeholder="Date of Birth">
                        </div>
                        <br>
                        <label>Phone Number: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_pn" value="<?php echo $pn;?>"class="form-control" required placeholder="Phone Number">
                        </div>
                        <br>
                        <label>Password: </label>
                        <div class="col-md-12">
                        <input type="text" name="up_pass" value="<?php echo $pass; ?>" class="form-control" required placeholder="Password">
                        </div>
                        <br>
